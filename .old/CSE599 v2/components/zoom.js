...
export class Zoom extends LitElement {
    constructor() {
        super();
        this.svgId = null;
        this.textId = null;
    ...
    hydrate(svg) {
        ...
        this.manipulator.zoom(this.extentX, this.extentY);
        this.emitSvg(this.manipulator.getState());
    }
...
customElements.define('zoom-clause', Zoom);
